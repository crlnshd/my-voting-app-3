...
# ══ ЛР3 ══
    ...
    ga_fm_lr3 = "sum" if "сума" in ga_mode_lr3 else "max"
    ...
    with st.spinner(f"ГА: мін. {label} відстаней..."):
        ga_perm, ga_val, ga_hist, ga_iters, ga_nsol = genetic_rank_cook(
            winners, triples,heuristic=heuristic_key,fitness_mode=ga_fm_lr3,pop_size=1000, generations=200, mut_rate=0.10)
